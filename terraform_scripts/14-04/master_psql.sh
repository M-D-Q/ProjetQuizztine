...
sudo apt-get -y install postgresql-12-repmgr repmgr-common



# create repmgr user and database
sudo -u postgres psql -c "CREATE ROLE ${REPMGR_USER} WITH REPLICATION LOGIN SUPERUSER PASSWORD '${REPMGR_PASSWORD}';"
